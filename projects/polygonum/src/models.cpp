...
ModelData::ModelData(Renderer* renderer, ModelDataInfo& modelInfo)
	...
	vsUBOs(renderer, BindingInfo(modelInfo.maxNumUbos_vs, modelInfo.activeInstances, modelInfo.uboSize_vs)),
	fsUBOs(renderer, BindingInfo(modelInfo.maxNumUbos_fs, modelInfo.maxNumUbos_fs, modelInfo.uboSize_fs)),
